// src/app/(protected)/content-generator/content-generator-client.tsx
'use client';
...
export function ContentGeneratorClient({ initialHistory, topicFromQuery }: { initialHistory: GeneratedContent[], topicFromQuery: string }) {
  ...
  const [selectedContent, setSelectedContent] = useState<GeneratedContent | null>(initialHistory.length > 0 ? initialHistory[0] : null);
                 ...
                 <CardContent className='p-4'>
                    <form ref={formRef} action={formAction} className="space-y-3">
                      ...
                      <div className="space-y-1">
                        ...
                        <Input id="topic" name="topic" placeholder={t('topicPlaceholder')} required defaultValue={topicFromQuery || ''} />
                      </div>
                      <div className="space-y-1">
            ...
            <div className="md:col-span-12 lg:col-span-8 h-full">
                <Card className="h-full flex flex-col min-h-[60vh] lg:min-h-0 shadow-sm">
                  <CardHeader className='p-4'>
                    ...
                    <CardDescription>
                      {selectedContent?.contentType ? `${t(selectedContent.contentType) || selectedContent.contentType} for ${selectedContent.gradeLevel}` : t('generatedContentDesc')}
                    </CardDescription>
                  </CardHeader>
